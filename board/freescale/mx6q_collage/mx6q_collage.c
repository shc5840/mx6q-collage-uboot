...
iomux_v3_cfg_t usdhc3_pads[] = {
	...
	MX6Q_PAD_SD4_DAT3__USDHC4_DAT3, /* CD_SWITCH */
	MX6Q_PAD_SD4_DAT4__USDHC4_DAT4, /* WP_SWITCH */
	MX6Q_PAD_SD3_RST__GPIO_7_8,     /* D15 */
};
...
{
	/* No delay required on COLLAGE board SD ports */
	return 0;
}
#endif
...
*could not be power off anymore*/
	...
	/* board id for linux */
	gd->bd->bi_arch_number = MACH_TYPE_MX6Q_COLLAGE;
...
int checkboard(void)
{
	printf("Board: %s-COLLAGE: %s Board: 0x%x [",
	mx6_chip_name(),
	mx6_board_rev_name(),
	fsl_system_rev);
