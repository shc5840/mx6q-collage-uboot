...
#define CONFIG_MXC
#define CONFIG_MX6Q
#define CONFIG_MX6Q_COLLAGE
#define CONFIG_FLASH_HEADER
#define CONFIG_FLASH_HEADER_OFFSET 0x400
#define CONFIG_MX6_CLK32	   32768

#define CONFIG_MX6_SECURE_BIN	0x4000
//#define CONFIG_SD_PLUGINBOOT
...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"bootargs_base=setenv bootargs console=ttymxc0,115200 jtag=on\0"\
		"bootargs_nfs=setenv bootargs ${bootargs} root=/dev/nfs "\
			"ip=dhcp nfsroot=${serverip}:${nfsroot},v3,tcp\0"\
		"bootcmd_net=run bootargs_base bootargs_nfs; "		\
			"dhcp; bootm\0"	\
		"bootargs_mmc=setenv bootargs ${bootargs} ip=none "     \
			"rootfstype=ext4 root=/dev/mmcblk0p1 rootwait video=mxcfb0 fec_mac=${ethaddr}\0"  \
...
#define CONFIG_SYS_PROMPT		"MX6Q COLLAGE U-Boot > "
